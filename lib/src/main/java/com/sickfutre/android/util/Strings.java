...
public class Strings {
    ...
    public static String[] split(String str, String delim) {
        return getNotEmpty(str).split(getNotEmpty(delim, SEMICOLON));
    }
    ...
    public static String joinBy(String sep, String... ss) {
        ...
        return joinBy(sep, null, Arrays.asList(ss));
    }

    public static String joinBy(String sep, Collection<String> ss) {

        return joinBy(sep, null, ss);
    }

    public static String joinBy(String sep, Function<String, String> transformer, Collection<String> ss) {
    ...
    public static <T> String joinObjectsBy(String sep, Function<T, String> transformer, Collection<? extends T> ss) {
        StringBuilder value = new StringBuilder();
